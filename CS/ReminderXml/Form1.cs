...
namespace ReminderXml
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            Appointment apt = new Appointment(DateTime.Now, DateTime.Now.AddHours(1), "Reminder Test");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            ReminderCollectionXmlPersistenceHelper myHelper = ReminderCollectionXmlPersistenceHelper.CreateSaveInstance(apt, DateSavingType.LocalTime);
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            Appointment apt = schedulerControl1.SelectedAppointments[0];
            apt.Reminders.AddRange(ReminderCollectionXmlPersistenceHelper.ObjectFromXml(apt, reminderEdit.Text, DateSavingType.LocalTime));
