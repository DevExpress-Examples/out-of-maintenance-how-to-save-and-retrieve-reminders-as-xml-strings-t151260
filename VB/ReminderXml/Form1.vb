...
Namespace ReminderXml
    Partial Public Class Form1
        ...
        Public Sub New()
            ...
            Dim apt As New Appointment(Date.Now, Date.Now.AddHours(1), "Reminder Test")
...
'            #Region "#remindertoxml"
            ...
            Dim myHelper As ReminderCollectionXmlPersistenceHelper = ReminderCollectionXmlPersistenceHelper.CreateSaveInstance(apt, DateSavingType.LocalTime)
